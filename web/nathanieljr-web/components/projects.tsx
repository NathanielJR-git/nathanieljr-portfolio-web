...
const DESKTOP_PROJECTS: Project[] = [
  ...
  { title: "Pasar Seni ITB 2025 Platform", description: "Part of the web development team of the official web platform for Pasar Seni ITB 2025.", techStack: ["Next.js",  "TailwindCSS"], link: "https://www.pasarseniitb.com/", image: "/projects/pasar-seni-itb.png", aspectRatio: "aspect-video" },
